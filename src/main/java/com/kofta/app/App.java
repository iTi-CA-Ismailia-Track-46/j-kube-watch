...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SharedIndexInformer<AlertSender> senderInformer = client.resources(AlertSender.class).inform();
        senderInformer.addEventHandler(new SenderController(client, registry));

        SharedIndexInformer<AlertReceiver> receiverInformer = client.resources(AlertReceiver.class).inform();
